...
var G__10768 = o;
(G__10768[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__10770__i < G__10770__a.length) {G__10770__a[G__10770__i] = arguments[G__10770__i + 0]; ++G__10770__i;}
  args = new cljs.core.IndexedSeq(G__10770__a,0,null);
} 
...
var G__10772 = o;
(G__10772[reagent.impl.template.cached_custom_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__10774__i < G__10774__a.length) {G__10774__a[G__10774__i] = arguments[G__10774__i + 0]; ++G__10774__i;}
  args = new cljs.core.IndexedSeq(G__10774__a,0,null);
} 
...
var G__10777 = props;
var G__10777__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__10777,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__10777);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__10777__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__10778){
...
var props = map__10779__$1;
var class$ = cljs.core.get.call(null,map__10779__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
if(cljs.core.coll_QMARK_.call(null,class$)){
return cljs.core.assoc.call(null,props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",cljs.core.keep.call(null,((function (map__10779,map__10779__$1,props,class$){
return (function (c){
...
});})(map__10779,map__10779__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__10781){
...
var on_write = cljs.core.get.call(null,map__10782__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,map__10782,map__10782__$1,on_write){
return (function (){
return reagent.impl.template.input_component_set_value.call(null,component);
});})(node_value,map__10782,map__10782__$1,on_write))
);
} else {
...
var G__10785 = jsprops;
(G__10785["defaultValue"] = value);

(G__10785["onChange"] = ((function (G__10785,v,value,on_change){
return (function (p1__10784_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__10784_SHARP_);
});})(G__10785,v,value,on_change))
);
...
var vec__10788 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__10788,(0),null);
var id = cljs.core.nth.call(null,vec__10788,(1),null);
var class$ = cljs.core.nth.call(null,vec__10788,(2),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___10792 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5461__auto___10792 == null)){
} else {
var key_10793 = temp__5461__auto___10792;
(jsprops["key"] = key_10793);
}
...
var temp__5461__auto___10794 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__5461__auto___10794 == null)){
} else {
var key_10795 = temp__5461__auto___10794;
reagent.impl.template.oset.call(null,jsprops,"key",key_10795);
}
...
var G__10796 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__10796["name"] = c);
...
var len__4730__auto___10802 = arguments.length;
var i__4731__auto___10803 = (0);
while(true){
if((i__4731__auto___10803 < len__4730__auto___10802)){
args__4736__auto__.push((arguments[i__4731__auto___10803]));

var G__10804 = (i__4731__auto___10803 + (1));
i__4731__auto___10803 = G__10804;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq10800){
var G__10801 = cljs.core.first.call(null,seq10800);
var seq10800__$1 = cljs.core.next.call(null,seq10800);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10801,seq10800__$1);
});
...
break;
default:
var G__10807 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__10807;
continue;
...
var n__4607__auto___10809 = a.length;
var i_10810 = (0);
while(true){
if((i_10810 < n__4607__auto___10809)){
(a[i_10810] = reagent.impl.template.as_element.call(null,(a[i_10810])));
...
var a = cljs.core.into_array.call(null,s);
var n__4607__auto___10812 = a.length;
var i_10813 = (0);
while(true){
if((i_10813 < n__4607__auto___10812)){
var val_10814 = (a[i_10813]);
if(((cljs.core.vector_QMARK_.call(null,val_10814)) && ((reagent.impl.template.key_from_vec.call(null,val_10814) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_10813] = reagent.impl.template.as_element.call(null,val_10814));

var G__10815 = (i_10813 + (1));
i_10813 = G__10815;
continue;
} else {
}
...
var ctx = ({});
var vec__10816 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__10816,(0),null);
var derefed = cljs.core.nth.call(null,vec__10816,(1),null);
...
var G__10819 = (cljs.core.count.call(null,argv) - first_child);
switch (G__10819) {
case (0):
...
break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv.call(null,((function (G__10819){
